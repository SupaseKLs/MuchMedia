...
export default function Home() {
    ...
    const ContentPhrases = [
        "At MuchMedia, we pride ourselves on delivering creative websites that prioritize",
        "user interaction. Our team collaborates closely with clients to understand their",
        "vision and goals, ensuring user-friendly interfaces and effective functionality."
    ];
