    ...
    <div className="w-11/12 mx-auto my-12">
      ...
      <div className="gap-4 grid grid-cols-2">
        {works.map((work, index) => (
          ...
          >
            <h1 className="text-3xl text-white pb-2">{work.title}</h1>
            <a
              href={work.href}
              className="py-3 px-6 bg-[#2B2B2B] rounded-full inline-flex items-center space-x-2 hover:bg-[#3A3A3A] transition-colors text-white font-bold"
            >
              Read more
            </a>
            <div className="absolute bottom-0 right-0">
            <img src={work.img} className="object-cover w-full h-80" width="100" height="100" alt="" />
            </div>
